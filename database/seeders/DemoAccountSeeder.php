...
{
    /**
     * Seeder ini membuat 1 akun demo yang KELIHATAN sudah lama dipakai —
    ...
    public function run(): void
    {
        ...
        // ---------------------------------------------------------------
        // PRODUCTS — beragam status stok, biar dashboard/insight kelihatan
        ...
        // ---------------------------------------------------------------
        // TRANSACTIONS — 30 hari terakhir, beberapa transaksi per hari,
        ...
        // ---------------------------------------------------------------
        // EXPENSES — beberapa pengeluaran dalam 30 hari terakhir
        // ---------------------------------------------------------------
        $expenseDefs = [
